...
export function Language_Interpreter_Request_Form() {
    ...
    const validateForm = () => {
        ...
        if (!values.locationRequiringService.trim())
            ...
            //validating the description will be done right before showing the confirmation popup
            //This is because it will default to N/A if nothing was typed
        }

        if (!values.requestedService) errors.requestedService = 'Requested Language is Required';
    ...
    const handleConfirming = async () => {
        try {
            const data = JSON.stringify({
                ...
                serviceCategory: 'Language Interpreter',
            });
    ...
    return (
        <main>
            <div className=" card relative z-10 formFont ">
                <h2 className="titleFont flex flex-col mx-auto text-3xl ">Language Interpreter</h2>
                ...
                <form onSubmit={handleSubmit}>
                    <div>
                        <h2 className="flex flex-col mx-auto formFont text-md text-center -mt-5">
                            Matthew Winchell, Catherine Foley
                        </h2>
                        ...
                        <div className={'mt-5'}>
                            ...
                            >
                                ...
                                <option value="Slavic, Non-Polish">Slavic, Non-Polish</option>
                                ...
                                <option value="Burmese and Southeast Asian">
                                    Burmese and Southeast Asian
                                </option>
                                <option value="Swahili and Sub-Saharan African">
                                ...
                                <option value="Hamitic and Near East Arabic">
                    ...
                    <div className={'mt-5'}>
                        ...
                        <textarea
                            name={'description'}
                            className={`cursor-pointer text-sm textFont w-full border p-2 'border-gray-300'} rounded`}
